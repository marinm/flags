export default
function toggleAutoplay(controls, autoplay, view, gamestate, canvas, socket, selectTile) {
    ...
    view.$('#autoplay-indicator').css('visibility', (controls.autoplay)? 'visible' : 'hidden');
